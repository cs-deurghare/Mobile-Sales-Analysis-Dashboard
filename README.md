...
- **Data Visualizations & Insights:**
  ...
  - **Brand Wise Breakdown:** Table summarizing Total Sales, Quantity, and Transactions for top brands (Apple, OnePlus, Samsung, Vivo, Xiaomi).
  - **Top 3 Models (Quantity-wise):** Bar chart highlighting top models (iPhone SE, OnePlus Nord, Galaxy Note 20).
  - **Transaction by Payment Method:** Donut chart breaking down UPI, Debit Card, Credit Card, and Cash transactions.
...
2. Open `Mobile_Sales_Project.pbix` PowerBI
3. Open `Mobile_Sales_Data.xlsx` Microsoft Excel
4. Use the month buttons and dropdown filters to interact with the dashboard.
